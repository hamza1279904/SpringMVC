...
<%
    String code=request.getParameter("code").toString();
     ...
     //  String username=request.getParameter("username").toString();
       ...
       System.out.println(code+" "+date+" "+username+"fsfsfs");
    %>

<div class="col-11" style="width: 95%;height: 95%; display: flex;align-items: center;">
<div class="p-2" style=" margin-left:auto; margin-right:auto; margin-top:  100px; ">

<form action="updateBook" method="POST" >
<div class="" style="padding: 3rem; background-color:  rgba(0, 0 ,0, 0.651); border-radius: 0.5rem">
<p style="font-family: monospace; font-size: 35px; color: white; margin-left: 50px; margin-right: auto; ">Update Book Details </p>
...
<div class=" container-fluid sm px-2 input-group-sm mb-2" style="display:flex;">
  ...
  <span type="date" class=" px-2" name="output"style="width: 170px; margin-left: 1rem; color: white; "aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"><%= code %></span>
 </div>
<div class=" container-fluid sm px-2 input-group-sm mb-2" style="display:flex;">
...
<div class=" container-fluid sm px-2 input-group-sm mb-2" style="display:flex;">
  ...
  <span type="date" class=" px-2" name="output"style="width: 170px; margin-left: 1rem; color: white; "aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"><%= date %> </span>
</div>
